...
- 实施状态：进行中。
- 已完成：[#15 扩展宿主身份与多会话注册表](https://github.com/jwxa/ExHyperV/issues/15)、[#16 本机与首台远程并列管理](https://github.com/jwxa/ExHyperV/issues/16)、[#17 多台远程宿主与隔离操作](https://github.com/jwxa/ExHyperV/issues/17)。
- 下一任务：[#18 旧数据与每宿主独立自动重连](https://github.com/jwxa/ExHyperV/issues/18)。
...
1. 开始 #18，补充旧数据展示与每宿主独立自动重连交互。
2. #19 和 #20 保持为并行可领取 frontier。
